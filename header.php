...
include'admin/ayar/baglan.php';
include'admin/ayar/function.php';
					...
					<div class="header-row">
						<div class="header-column">
							<div class="header-logo">
								<a href="index.php">
									<img alt="<?php echo $ayarcek['ayar_title']; ?> firma logosu" width="164" height="54" data-sticky-width="82" data-sticky-height="40" data-sticky-top="33" src="<?php echo $ayarcek['ayar_logo'];?>">
								</a>
							</div>
						</div>
						<div class="header-column">
