<footer class="short" id="footer">
					...
					<div class="row">
						...
						<div class="col-md-3">
							...
							<ul class="social-icons mt-lg">
								...
								<li class="social-icons-linkedin"><a href="<?php echo $ayarcek['ayar_youtube']; ?>" target="_blank" title="Youtube"><i class="fa fa-youtube"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="footer-copyright">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<p>© Copyright 2018. Bütün Hakları Saklıdır. | <a href="http://www.yazgelistir.net" target="_blank"><?php echo $ayarcek['ayar_autor']; ?></a></p>
							</div>
						</div>
					</div>
				</div>
