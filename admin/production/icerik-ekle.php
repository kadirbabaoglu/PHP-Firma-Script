                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name"  required="required" name="icerik_ad" placeholder="Haber başlığınızı yazın..." class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <script type="text/javascript">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name"  required="required" name="icerik_keyword" placeholder="Anahtar kelimelierinizi yazın..." class="form-control col-md-7 col-xs-12">
                        </div>
                        </div>
